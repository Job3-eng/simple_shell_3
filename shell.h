...
/* toem_exits.c functions*/
char *_strncpy(char *, char *, int);
char *_strncat(char *, char *, int);
char *_strchr(char *, char);

/* toem_tokenizer.c functions */
char **strtow(char *, char *);
char **strtow2(char *, char);

/* toem_realloc.c functions*/
char *_memset(char *, char, unsigned int);
void ffree(char **);
void *_realloc(void *, unsigned int, unsigned int);

/* toem_memory.c the functions*/
int bfree(void **);

/* toem_atoi.cthe functions */
int interactive(info_t *);
int is_delim(char, char *);
int _isalpha(int);
int _atoi(char *);

/*the function toem_errors1.c */
int _erratoi(char *);
...
/*the function toem_builtin.c */
int _myexit(info_t *);
int _mycd(info_t *);
int _myhelp(info_t *);

/* toem_builtin1.c the function*/
int _myhistory(info_t *);
int _myalias(info_t *);

/*toem_getline.c the function*/
ssize_t get_input(info_t *);
int _getline(info_t *, char **, size_t *);
void sigintHandler(int);

/*the function toem_getinfo.c */
void clear_info(info_t *);
void set_info(info_t *, char **);
void free_info(info_t *, int);

/* toem_environ.c the function */
...
/* toem_getenv.c the function*/
char **get_environ(info_t *);
int _unsetenv(info_t *, char *);
int _setenv(info_t *, char *, char *);

/* toem_history.c functions*/
